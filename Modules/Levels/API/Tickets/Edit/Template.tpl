...
<div id="application-Quests-edit">
    <a href="javascript:void(0)" onclick="Rune.Levels.Tickets.save('<?php echo $entity->getKey(); ?>', '<?php echo $entity->getKeyQuest(); ?>', '<?php echo $quest->getStatus(); ?>');">Save</a>
    <a href="javascript:void(0)" onclick="Rune.Levels.Quest.show('<?php echo $quest->getStatus(); ?>');">Cancel</a>
    <hr/>
    <table>
