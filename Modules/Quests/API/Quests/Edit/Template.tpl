...
<div id="application-Quests-edit">
    <a href="javascript:void(0)" onclick="Rune.Quests.Quests.save('<?php echo $entity->getKey(); ?>');">Save</a>
    <a href="javascript:void(0)" onclick="Rune.Quests.Quests.show('<?php echo $entity->getKey(); ?>');">Cancel</a>
    <hr/>
    <table>
