<div id="modules-degrees-collection">
    <link href="<?php echo ROOT_URL; ?>/Modules/Degrees/API/Degrees/Collection/Style.css" rel="stylesheet" />

    <a href="javascript:void(0)" class="butn" onclick="Rune.Degrees.plan();">Plan</a>
    <a href="javascript:void(0)" class="butn" onclick="Rune.Degrees.Lessons.create();">Create lesson</a>
                ...
                <?php if(isset($lessons[$entity->getKey()])): ?>
                    ...
                    <?php foreach($lessons[$entity->getKey()] as $key => $lesson): ?>
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0)" class="butn" onclick="Rune.Degrees.Lessons.edit('<?php echo $lesson->getKey(); ?>');">Edit</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
