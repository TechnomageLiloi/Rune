...
<div id="ticket-edit">
    <a href="javascript:void(0)" onclick="Rune.Degrees.Lessons.save('<?php echo $entity->getKey(); ?>');">Save</a>
    <hr/>
    <table style="width: 100%;">
        ...
        <tr><td>Degree</td><td><input type="text" name="key_degree" value="<?php echo $entity->getKeyDegree(); ?>"/></td></tr>
