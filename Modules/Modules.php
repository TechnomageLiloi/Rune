...
class Modules
{
    public static function collect(APIManager $manager): APIManager
    {
        ...
        $manager->add(new Method('Rune.Exams.Questions.Done', '\Liloi\Rune\Modules\Exams\API\Questions\Done\Method::execute'));
        ...
        $manager->add(new Method('Rune.Exams.Inventory.Inventory', '\Liloi\Rune\Modules\Exams\API\Inventory\Inventory\Method::execute'));
        ...
        $manager->add(new Method('Rune.Degrees.Plan', '\Liloi\Rune\Modules\Degrees\API\Degrees\Plan\Method::execute'));

        $manager->add(new Method('Rune.Lessons.Edit', '\Liloi\Rune\Modules\Degrees\API\Lessons\Edit\Method::execute'));
        $manager->add(new Method('Rune.Lessons.Save', '\Liloi\Rune\Modules\Degrees\API\Lessons\Save\Method::execute'));
        $manager->add(new Method('Rune.Lessons.Create', '\Liloi\Rune\Modules\Degrees\API\Lessons\Create\Method::execute'));
