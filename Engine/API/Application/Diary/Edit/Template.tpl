...
<div id="application-diary-edit">
    <a href="javascript:void(0)" onclick="Rune.Application.Diary.save('<?php echo $entity->getKey(); ?>');">Save</a>
    <a href="javascript:void(0)" onclick="Rune.Application.Diary.show('<?php echo $entity->getKey(); ?>');">Cancel</a>
    <hr/>
    <table>
